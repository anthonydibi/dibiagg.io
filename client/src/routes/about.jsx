import {Grid, Heading, Center, Box, Text, Stack, useColorModeValue, GridItem, Tooltip, Image} from "@chakra-ui/react"
                    ...
                    <Stack spacing={9} px={{base: 0, md: 20}}>
                        ...
                        <Grid flex={"1"} autoColumns={"1fr"} gap={"3"} templateColumns={['repeat(1, 1fr)', null, 'repeat(2, 1fr)']}>
                            <GridItem>
                                ...
                                color={"white"}
                                text={"I used ChakraUI to help with styling. I've used Bootstrap in the past, but I hate how opinionated it is. Chakra provides useful primitives and hooks that make it easy to create custom components."}
                                heading={"ChakraUI"}
                                rounded={"true"}>
                                </IconCard>
                            </GridItem>
                            <GridItem>
                                ...
                                color={"white"}
                                text={"React is really popular and has tons of good documentation, so I decided to use it to structure the front end. I also find it really fun to use, I'm still new to it but I like hooks and being able to write components as functions."}
                                heading={"React.js"}
                                rounded={"true"}>
                                </IconCard>
                            </GridItem>
                            <GridItem>
                                ...
                                color={"white"}
                                text={"All of the backend data is stored using PostgreSQL. Native JSON support makes it really easy to maintain state for interactive stuff like the graffiti wall, which is my first little project on this site."}
                                heading={"PostgreSQL"}
                                rounded={"true"}>
                                </IconCard>
                            </GridItem>
                            ...
                            <GridItem>
                                ...
                                color={"white"}
                                text={"I wrote a Node.js API which allows drawings on the graffiti page to be posted and retrieved from the PostgreSQL database. I used the Express framework to streamline middleware and routing."}
                                heading={"Node.js"}
                                rounded={"true"}>
                                </IconCard>
                            </GridItem>
