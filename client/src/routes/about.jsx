                    ...
                    <Stack spacing={9} px={{base: 0, md: 20}}>
                        ...
                        <Grid flex={"1"} autoColumns={"1fr"} gap={"3"} templateColumns={['repeat(1, 1fr)', null, 'repeat(2, 1fr)']}>
                            <GridItem>
                                ...
                                color={"white"}
                                text={"I used ChakraUI to help with styling. I've used Bootstrap in the past, but I hate how opinionated it is. Chakra provides useful style primitives that make it easy to create custom components. It also made implementing dark mode relatively simple."}
                                heading={"ChakraUI"}
                                rounded={"true"}>
                                </IconCard>
                            </GridItem>
                            <GridItem>
                                ...
                                color={"white"}
                                text={"React is really popular and has tons of good documentation, so I decided to use it to structure the UI. I also find it really fun to use, I'm still new to it but I like hooks and being able to write components as functions."}
                                heading={"React.js"}
                                rounded={"true"}>
                                </IconCard>
                            </GridItem>
