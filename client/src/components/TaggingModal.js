        ...
        <ModalContent p={{ base: 2, md: 4 }}>
          ...
          <ModalBody>
            ...
            <Text fontSize={"lg"}>
              ...
              log in to your email to open a verification link. Yes, this means
              that you could steal someone else's name and pass your drawings as
              theirs. But you wouldn't do that, right? If you did, would the
              thought of what you've done haunt you at night? Would it consume
              you until there is nothing left until the thought itself? Would
              you go to extreme measures to make it go away? But then what is
